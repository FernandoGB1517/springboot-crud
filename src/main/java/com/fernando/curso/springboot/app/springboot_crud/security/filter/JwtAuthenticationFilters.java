...
import static com.fernando.curso.springboot.app.springboot_crud.security.TokenJwtConfig.*;
...
public class JwtAuthenticationFilters extends UsernamePasswordAuthenticationFilter{
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        String token = Jwts.builder()
                .subject(username)
                .claims(claims)
                .expiration(new Date(System.currentTimeMillis()+3600000)) // una hora mas de su creacion
